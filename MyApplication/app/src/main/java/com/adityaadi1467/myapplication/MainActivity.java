...
public class MainActivity extends ActionBarActivity {
    ...
    static ChatHeadContainer chatContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  windowManager.addView(findViewById(R.id.mainlayout), params);
     //   khali k = new khali(chat)
       // startService(new Intent(getApplicationContext(), khali.class));
